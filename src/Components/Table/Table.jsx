...
function Table() {
        ...
        { week: "Test Week", sets: 1, reps: 1, exercises: ["Test1", "Test2", "Test3"]},
        { week: 1, sets: 4, reps: 6, exercises: ["Test", "Test2", "Test3"]},
        { week: 2, sets: 4, reps: 6, exercises: ["Test", "Test2", "Test3"]},
        { week: 3, sets: 4, reps: 5, exercises: ["Test", "Test2", "Test3"]},
        { week: 4, sets: 4, reps: 6, exercises: ["Test", "Test2", "Test3"]},
        { week: 5, sets: 3, reps: 5, exercises: ["Test", "Test2", "Test3"]},
        { week: 6, sets: 4, reps: 4, exercises: ["Test", "Test2", "Test3"]},
        { week: 7, sets: 4, reps: 3, exercises: ["Test", "Test2", "Test3"]},
        { week: 8, sets: 3, reps: 5, exercises: ["Test", "Test2", "Test3"]},
        { week: 9, sets: 4, reps: 3, exercises: ["Test", "Test2", "Test3"]},
        { week: 10, sets: 3, reps: 2, exercises: ["Test", "Test2", "Test3"]},
        { week: 11, sets: 3, reps: 1, exercises: ["Test", "Test2", "Test3"]},
        { week: 12, sets: 4, reps: 3, exercises: ["Test", "Test2", "Test3"]},
    ]
  ...
  return (
    <div className={styles.routineContainer}>
      ...
      <button className={styles.cycleButton} onClick={repeatCycle}>Repeat Cycle</button>
    </div>
  );
}
...
// Separate into tables of "12 week cycles", add button to repeat cycle
